cmd_drivers/clk/sunxi/clk_sunxi.o := aarch64-linux-gnu-gcc -Wp,-MD,drivers/clk/sunxi/.clk_sunxi.o.d -nostdinc -isystem /home/matt/Documents/Remix_Mini_PC/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/../lib/gcc/aarch64-linux-gnu/7.5.0/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -I./dts/upstream/include  -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-unused-but-set-variable -Werror=date-time -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-x18 -mgeneral-regs-only -pipe -march=armv8-a+crc -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-sunxi/include    -DKBUILD_BASENAME='"clk_sunxi"'  -DKBUILD_MODNAME='"clk_sunxi"' -c -o drivers/clk/sunxi/clk_sunxi.o drivers/clk/sunxi/clk_sunxi.c

source_drivers/clk/sunxi/clk_sunxi.o := drivers/clk/sunxi/clk_sunxi.c

deps_drivers/clk/sunxi/clk_sunxi.o := \
    $(wildcard include/config/clk/sun4i/a10.h) \
    $(wildcard include/config/clk/sun5i/a10s.h) \
    $(wildcard include/config/clk/sun6i/a31.h) \
    $(wildcard include/config/clk/sun8i/a23.h) \
    $(wildcard include/config/clk/sun8i/a83t.h) \
    $(wildcard include/config/clk/sun6i/a31/r.h) \
    $(wildcard include/config/clk/sun8i/h3.h) \
    $(wildcard include/config/clk/sun8i/r40.h) \
    $(wildcard include/config/clk/sun8i/v3s.h) \
    $(wildcard include/config/clk/sun9i/a80.h) \
    $(wildcard include/config/clk/sun50i/a64.h) \
    $(wildcard include/config/clk/sun20i/d1.h) \
    $(wildcard include/config/clk/sun50i/h6.h) \
    $(wildcard include/config/clk/sun50i/h6/r.h) \
    $(wildcard include/config/clk/sun50i/h616.h) \
    $(wildcard include/config/clk/suniv/f1c100s.h) \
